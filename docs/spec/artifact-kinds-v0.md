...
**Historical collision audit refs:** fork product `d36f39336b05036f90ba20e273746374c25aaf3e` and official upstream observed at `07a3c768d619db31fee3f0590f9433cdd1213e8f`. Repeat the audit before registration.

## Goal

Reserve kind numbers for Preview Studio durable and session events without colliding with existing Buzz or NIP kinds, and without registering them in the relay yet.
...
**Free and contiguous for durable Preview Studio regulars:** `44000–44099` (immediately before notifications `44100`).
