# BUZZ — LIVE PREVIEW STUDIO user guide

BUZZ — LIVE PREVIEW STUDIO is the fork's local proofing room. Its complete production journey is an agent-posted website URL or an imported image, video, or local PDF. Comments, revision metadata, and decisions remain on this device.
...
The event kinds under `docs/spec/` are proposals, not registered production kinds. See [BUZZ — LIVE PREVIEW STUDIO architecture](../architecture/preview-studio.md) and [Known issues](../evidence/known-issues.md).
