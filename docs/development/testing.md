...
BUZZ — LIVE PREVIEW STUDIO has focused Node tests under `desktop/src/features/preview-studio/lib/` and E2E specs under `desktop/tests/e2e/`. Keep these evidence distinctions:
