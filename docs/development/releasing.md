...
7. run the local upstream desktop contract and confirm its no-upgrade path at the recorded
   baseline; and
8. record the released commit in the evidence ledger.

Do not describe the updater as automatic and do not add repository workflows: upstream
releases remain local, reviewed integration work.
