...
The Flutter client covers activity, channels, forum, home, invitations, device pairing, profile, Pulse, search, and settings. Desktop-only surfaces—including Preview Studio—should not be inferred from shared event kinds or designs.
...
Preview Studio currently has no mobile, public-web, or admin implementation.
