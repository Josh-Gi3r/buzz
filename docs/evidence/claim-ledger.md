...
| Full `just ci` passes | Verified on post-`712fe36a` worktree | Rerun exited 0 after an ordering-only rustfmt fix; PostgreSQL, fixture/model, OS-keychain, and release-performance ignored tests remain outside the run. |
