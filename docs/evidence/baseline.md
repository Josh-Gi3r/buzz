...
| Current editorial rewrite | Uncommitted | Must receive an exact commit before release claims or clean-clone verification. |
| Upstream release detector | Uncommitted branch state | Weekly/manual stable-tag detector and integration-PR preparation; not yet proven live. |
...
No immutable public documentation/release tag has been verified. A future release must add its tag and clean-clone proof rather than rewriting this historical record.
