...
This matrix describes BUZZ — LIVE PREVIEW STUDIO on the fork's current Block Buzz Desktop `v0.5.9` baseline (`ee33722615ca1e7b8efb03e2ed641d99448c8899`).
...
|---|---|---|
| Desktop | Implemented | Broadest Buzz client and only BUZZ — LIVE PREVIEW STUDIO client. |
...
## BUZZ — LIVE PREVIEW STUDIO fork addition
